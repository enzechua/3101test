...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "UsingCalculatorDivisions", "    In order to conquer divisions \n    As a division enthusiast\n    I want to und" +
                    "erstand a variety of division operations", ProgrammingLanguage.CSharp, ((string[])(null)));
...
#line 9
    testRunner.When("I have entered \"4\" and \"2\" into the calculator and press divide", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 10
    testRunner.Then("the division result should be \"2\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
